...
//     → v1.83.2 — 2026-08-25, 2026-09-14, under the security-fix exception
//     (GHSA-vp52-pcj8-j9qc; see daemon/go.mod), with x/net v0.58.0 and
//     x/text v0.41.0 — kept at the workspace-wide selection.
